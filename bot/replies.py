...
manage_acc_texts = {
	...
	'nan': "ID приложения должен быть числом.",
...
# user conversation
connect_texts = {
	'app_id': "Введите ID приложения, к которому будут подключены аккаунты.",
	'nan': "ID должен быть числом.",
	'app_not_found': "Приложение с таким ID не найдено.",
	'ad_account': "ID приложения: {}.\nВведите ID аккаунта.",
	'finish': (
		"Аккаунты, которые будут добавлены к приложению {}:\n{}\n\n"
		"Подключите эти или введите ещё."
	),
	'working': "Подключение...",
	'result_success': "К приложению {} добавлено аккаунтов: {}.",
	'result_partial': "\nНе добавились:\n{}",
	'result_fail': "Ошибка подключения к фейсбуку."
}
